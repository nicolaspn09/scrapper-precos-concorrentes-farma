...
def handle_exception(bloco_codigo, e):
    ...
    assunto_email = "Erro no RPA da Droga Raia 0-2000"
...
def envia_email_execucao():
    ...
    mensagem['Subject'] = 'Python Consulta Droga Raia 0-2000'
    ...
    try:
        ...
        assunto_email = "Erro no RPA da Consulta Droga Raia 0-4700"
...
def acessa_site():
    ...
    try:
        # Forma o SQL
        sql = f"select cd_ean from msv.dim_mercadoria where cd_ean <> 0 and cd_ean <> 9999999999999 limit 4700 offset 0"
...
O RPA finalizou a busca dos valores da Droga Raia das infos de 0-2000!
"""

assunto_email = f"RPA Busca Dados Droga Raia 0-2000"
